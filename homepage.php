...
// Static user ID target used since session controls are removed to allow automated tools like sqlmap to run smoothly
$user_id = 1; 
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['action']) && $_POST['action'] === 'update_email') {
    ...
    // Completely insecure query execution string
...
// Fetch user entry dynamically for verification
...
<title>Property Rental Lab (Public Testing Mode)</title>
...
<div class="container">
<a class="navbar-brand" href="#">🏠 Property Rental Lab (Public Testing Mode)</a>
        ...
        <div class="col-md-8">
            <div class="lab-box shadow-sm">
                ...
                <p class="text-muted small">
                    Current Registered Email (Target User 1): <b><?= htmlspecialchars($user_profile['email'] ?? 'None'); ?></b>
                </p>
