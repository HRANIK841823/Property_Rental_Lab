...
// HYBRID AUTHENTICATION Fallback for automated tools
...
.lab-box { border: 2px dashed #0d6efd; background: #fff; padding: 20px; border-radius: 10px; margin-bottom: 30px; }
.section-title { margin-top: 40px; margin-bottom: 20px; font-weight: bold; color: #333; border-left: 5px solid #dc3545; padding-left: 15px; }
...
<div class="container mt-4">
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-md-8">
            <div class="lab-box shadow-sm text-center">
                <h4 class="text-primary pb-2">⚙️ Account Profiles Dashboard</h4>
                <p class="text-muted mb-2">
                    Current associated email identifier: <code><?= htmlspecialchars($user_profile['email'] ?? 'None'); ?></code>
                </p>
                <div class="p-1">
                    <a href="update_email.php" class="btn btn-primary px-5">Go to Update Email Settings</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800" class="card-img-top" alt="Property">
                <div class="card-body">
                    <h5>Luxury Family Apartment</h5>
                    <p class="text-muted">📍 Dhaka</p>
                    <h6 class="text-primary fw-bold">25,000 BDT / Month</h6>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1484154218962-a197022b5858?w=800" class="card-img-top" alt="Property">
                <div class="card-body">
                    <h5>Modern Studio Flat</h5>
                    <p class="text-muted">📍 Chattogram</p>
                    <h6 class="text-primary fw-bold">18,000 BDT / Month</h6>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800" class="card-img-top" alt="Property">
                <div class="card-body">
                    <h5>Cozy Suburban Duplex</h5>
                    <p class="text-muted">📍 Sylhet</p>
                    <h6 class="text-primary fw-bold">35,000 BDT / Month</h6>
                </div>
            </div>
        </div>
    </div>
